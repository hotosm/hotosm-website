...
<table style="border-bottom: 1px solid black">
	<tr>
		<td>Role:</td>
		<td style="border-left: 1px solid black">Coordonnateur National</td>
	</tr>
	<tr>
		<td>ADate de clôture de la candidature:</td>
		<td style="border-left: 1px solid black">30 novembre 2023</td>
	</tr>
<tr>
		<td>Date de début du projet:</td>
		<td style="border-left: 1px solid black">18 decembre 2023</td>
	</tr>
	<tr>
		<td>Durée du projet:</td>
		<td style="border-left: 1px solid black">5 mois</td>
	</tr>
<tr>
		<td>Lieu de travail:</td>
		<td style="border-left: 1px solid black">Sierra Leone, Cameroun</td>
	</tr>
<tr>
		<td>Type de contrat:</td>
		<td style="border-left: 1px solid black">Consultant</td>
	</tr>
<tr>
		<td>Contact direct:</td>
		<td style="border-left: 1px solid black">Gestionnaire de Projet, West & Northern Africa (WNA)</td>
	</tr>
</table>
...
L'appel à proposition complet est disponible [ici.](https://docs.google.com/document/d/1fphVlY8Kl-fMFB0MEutFfLfIhAVEhTPGc8R14Q_qJ84/edit)
