...
Apply Form Link: mailto:info@hotosm.org
Page Contact:
...
4. Please describe your involvement and expertise in the following elements of Strategy Creation:
    A. Planning
    B. Facilitation
    C. Engagement with different stakeholders: board, membership, community (our implementation stakeholders and partners), staff
    D. Proven experience developing strategies which deliver localisation, community empowerment, and sharing power
    E. Technical expertise in humanitarian and/or open source technology NGOs or nonprofits
