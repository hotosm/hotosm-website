...
block-1:
  ...
  intro2: Challenges to community public health arise from unequal healthcare access,
    environmental factors, and vulnerabilities. Better open maps of healthcare infrastructure,
    services, and environmental factors can improve public health access and programming.
    Open mapping, particularly through [OpenStreetMap (OSM)](https://www.openstreetmap.org),
    supports this by enabling humanitarian and development organizations to take informed
    actions. **Mapping healthcare locations, services, and disease occurrences helps
    plan vaccination campaigns, public health programs, and monitor services**. Core
    OSM datasets include information on healthcare facilities, transportation, and
    environmental data, crucial for addressing health barriers and improving community
    health outcomes.
  sub-block:
