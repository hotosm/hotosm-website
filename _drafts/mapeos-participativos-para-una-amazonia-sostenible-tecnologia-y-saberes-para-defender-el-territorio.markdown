---
title: 'Mapeos participativos para una Amazonía sostenible: tecnología y saberes para
  defender el territorio'
date: 2025-06-23 04:34:00 Z
Summary Text: Apoyado por el Instituto Interamericano para la Investigación del Cambio
  Global (IAI), el proyecto es liderado por HOT, la Universidad Mayor de San Andrés
  de Bolivia y la Universidad Autónoma Latinoamericana de Colombia. A través del uso
  de tecnologías libres y el diálogo de saberes, busca fortalecer la autonomía territorial
  de comunidades en la Amazonía.
...
Estas actividades en campo forman parte de los ciclos formativos diseñados para cada país. A través de ellos, se busca fortalecer las capacidades de las comunidades locales en el uso de tecnologías libres de georreferenciación. Al mismo tiempo, y bajo un enfoque transdisciplinario, se promueve un diálogo de saberes con estas comunidades para identificar áreas críticas de conservación, conflictos socioambientales, como la deforestación, la minería, los cultivos ilícitos o los impactos del cambio climático, así como las acciones de protección que ellas mismas impulsan.

# Bolivia

En Bolivia, el equipo de la UMSA eligió trabajar con la comunidad de Sapecho, ubicada en el municipio de Palos Blancos, provincia de Sud Yungas, en el departamento de La Paz. La decisión se basó en su cercanía con la estación experimental de la universidad, lo que facilita el acompañamiento técnico y logístico. Esta región se caracteriza por su gran diversidad natural, que incluye bosques tropicales y serranías, así como por una rica herencia cultural conformada por comunidades indígenas e interculturales que habitan el territorio.

La comunidad de Sapecho está compuesta en su mayoría por personas del pueblo Tacana. Por ello, para esta primera actividad, fue el [Consejo Indígena del Pueblo Tacana (CIPTA)](https://es.wikipedia.org/wiki/Consejo_Ind%C3%ADgena_del_Pueblo_Tacana) quien designó a las y los miembros de la comunidad que participarían en el taller. Como parte del enfoque interdisciplinario y colaborativo del proyecto, también se integró a los guardaparques de la región y a los bomberos de La Paz, quienes habitualmente atienden los incendios forestales en los alrededores de Sapecho, reconociendo así el valor del trabajo articulado entre distintos actores para la gestión del territorio.

El taller, diseñado y facilitado por HOT y la UMSA, se desarrolló bajo un enfoque participativo, interdisciplinario y práctico. Combinó sesiones teóricas, actividades de campo y espacios de diálogo comunitario. La metodología buscó articular el conocimiento tecnológico, como el uso de drones a través de [Drone Tasking Manager](https://dronetm.org/), OpenStreetMap y [Chat Map,](https://www.hotosm.org/tech-suite/chatmap/) con los saberes locales, con el objetivo de empoderar a las y los participantes y generar datos útiles para la prevención de incendios y la gestión integral del territorio.
...
Emilio Mariscal, Gerente de Ingeniería de Software de HOT, resalta que la actividad en Bolivia fue más que una prueba de herramientas: fue un verdadero intercambio de saberes. Subraya que el desarrollo tecnológico con impacto no puede hacerse en aislamiento ni sólo desde la pantalla. En sus palabras:
...
En Colombia, el equipo de UNAULA, en coordinación con personal de HOT, se desplazó al territorio de Santa Rosa, sede del Cabildo Wairari Atún Sacha, ubicado en el municipio de Santa Rosa, departamento del Cauca. Esta comunidad pertenece al pueblo Inga, y su casa cabildo —centro de organización política y cultural— se encuentra en la vereda La Tarabita. El Cabildo Guairaría Atún Sacha se consolidó como una respuesta organizativa ante las diversas problemáticas del municipio, donde previamente no existía representación indígena en la cabecera municipal.
...
Leonardo Jiménez, director del Centro de Estudios POMOTE de la UNAULA, compartió que la jornada en Santa Rosa fue mucho más que un ejercicio técnico. Desde su perspectiva, el taller representó una experiencia transformadora tanto para el equipo facilitador como para la comunidad:
...
Los resultados técnicos del ejercicio no tardaron en materializarse: se generó una ortofoto del territorio disponible ya en OpenAerialMap, y las imágenes tomadas desde tierra fueron cargadas en Mapillary. Sin embargo, para Juan, lo más importante no fueron los productos, sino el proceso:
