...
En segundo lugar, es necesario fortalecer las capacidades técnicas y el acceso a herramientas de mapeo abiertas y colaborativas. Esto implica brindar capacitación y recursos para que las personas y las organizaciones puedan utilizar y contribuir a plataformas abiertas como OpenStreetMap. Al hacerlo, se fomenta la autonomía y la capacidad de las comunidades para mapear y visualizar las realidades locales, fortaleciendo así su capacidad para abogar por sus derechos y defenderse de amenazas.
