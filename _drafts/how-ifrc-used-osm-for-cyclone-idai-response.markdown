...
## What will are the IFRC doing with OpenStreetMap data?
...
It’s hard to overstate that how useful HOT is for providing the starting point for us. We’re all big fans!