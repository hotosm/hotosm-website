...
Block 2:
  ...
  Rectangle-1:
    ...
    Header: Low Barrier to Entry
    Highlight: Create a chat group and ask people to share locations and messages
  Rectangle-2:
    Icon: fa-solid fa-comments
    Header: Chat-based
    Highlight: Map while chat, adding easy support and moderation
  Rectangle-3:
