...
Block 0:
  ...
  Image: "/uploads/Lima-Drone-Flight%20Demo-Cut.JPG"
Block 1:
  Section: What is it?
...
Block 2:
  ...
  Rectangle-2:
    ...
    Highlight: Current commercial drone platforms don't enable multiple operators
      to collaborate to cover a large area. <strong>DroneTM empowers communities to
      work together to image their own environment seamlessly and at scale.</strong>
  Rectangle-3:
