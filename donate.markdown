...
position: 13
Summary Text: |-
  <h2>Support our work in the aftermath of Morocco's earthquake</h2>
  <h3>HOT's <a href="https://www.hotosm.org/hubs/open-mapping-hub-west-and-northern-africa">West and Northern Africa Hub</a> is coordinating with local communities to <a href="https://tasks.hotosm.org/explore?campaign=Morocco%20Earthquake%202023">map the areas affected by the earthquake</a> and provide reliable, up-to-date map data to humanitarian actors on the ground. Your donations are crucial to keep this work going.</h3>
