...
Omran NAJJAR is the AI Product Owner in Humanitarian OpenStreetMap Team with +19 year experience in software engineering, information systems, advanced data management and artificial intelligence. Omran holds a MSc in EEE, Computer Science, Turkey (2020) with research thesis and experimental application on Extreme Learning Machine (ELM) algorithms and a MSc in Data Analytics and Information Systems Management, Germany (2023) with research focus on spatial and temporal analysis on OSM - Nepal.
