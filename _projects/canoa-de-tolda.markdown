...
- Brazil
position: 3
Project Summary Text: 'In this partnership between HOT and Canoa de Tolda – Sociedade
  Socioambiental do Baixo São Francisco, for the first time in the region, data was
  collected in high-precision, collaborative digital terrain modeling to enable the
  mapping of populations in areas at-risk of flooding. Canoa de Tolda Project aimed
  to train local people from the lower stretch of São Francisco River basin to collect
  data.
...
- OpenMapDevelopment Tanzania (OMDTZ)
- Rainbow Sensing
- OpenDroneMap
Duration:
