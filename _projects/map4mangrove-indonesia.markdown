...
* **Field mapping** – At the end of July 2025, we conducted a two-day field mapping activity with partners, university students, and local community representatives. Together, we explored, mapped, and documented all five rehabilitation sites. The activities included data collection using KoboToolbox, street-level imagery using Mapillary, and aerial mapping using drone.
<hr>
