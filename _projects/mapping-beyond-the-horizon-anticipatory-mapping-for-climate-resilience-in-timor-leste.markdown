...
This project was a collaborative effort fostering climate resilience initiatives and unified responses to potential disasters through partnerships with local stakeholders, the Timor-Leste Red Cross, Red Cross Crescent Climate Centre, HumanitarianOpenStreetMap Team. Strengthening these partnerships further will be an essential focus on the way forward. As the digital cartography continues, this project serves as digital advance in Timor-Leste, setting the stage for expanding Anticipatory Mapping effort. The goal is clear: to fortify climate resilience, support Anticipatory Action plannings across the Island, and enhance preparedness in the face of changing climate patterns and extreme events.