---
title: Mapeos participativos para una Amazonía sostenible
date: 2025-04-25 15:28:00 Z
Project Summary Text: El proyecto busca fortalecer las capacidades comunitarias en
  Bolivia, Colombia y Guatemala para desarrollar mapeos participativos que contribuyan
  a la conservación de los ecosistemas forestales tropicales —incluyendo la Amazonía
  y otros bosques de Mesoamérica— y a la adaptación al cambio climático. A través
...
*Este trabajo está siendo realizado con una subvención del [Instituto Interamericano para la Investigación del Cambio Global (IAI)](https://www.iai.int/es) Fondo Semilla, Bosques Tropicales en las Américas: Enfoques Transdisciplinarios para Transformaciones Ambientales, SG-TF-2024.*