...
Project Summary Text: The Map2Mitigate project aims to generate basic open mapping
  ...
  (Bahia, Brazil). Through mapathons, technical training, and drone use, the project
  enables communities to obtain up-to-date data about their territories, facilitating
  disaster prevention and evidence-based public action.
