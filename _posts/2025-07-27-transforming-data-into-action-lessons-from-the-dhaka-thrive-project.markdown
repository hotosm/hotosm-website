...
Summary Text: Discover how community-led open mapping is transforming lives in Dhaka’s
  ...
  Project, where data becomes a tool for justice, resilience, and local enhancement.
...
On March 21, 2024, I received an invitation from the Open Mapping Hub Asia-Pacific and the amazing [Mikko Tamura](https://www.hotosm.org/people/mikko-tamura/), Community Manager at [HOT](https://www.hotosm.org/). I was invited to coordinate the Open Mapping Guru field visit and data collection in Dhaka, and I was absolutely thrilled. It was not just an opportunity but a milestone for me as a mapper, trainer, and community builder.

We were joined by inspiring international guests like [Can Unen](https://www.hotosm.org/people/can-unen/), [Honey Grace Fombuena](https://www.hotosm.org/people/honey-grace-fombuena/), and [Harry Mahardhika Machmud](https://www.hotosm.org/people/harry-mahardhika-machmud/) from HOT. Along with other Open Mapping Gurus and the local team from World Vision Bangladesh, we prepared to map two vulnerable areas in Mirpur: Duaripara and Millat Camp.

I led the [Mapillary](https://www.mapillary.com/app/user/brazilsingh) team, working closely with Harry, while others led [ODK](https://getodk.org/) data collection and [Field Papers](https://fieldpapers.org/). Before heading out, I trained our volunteers on how to use Mapillary and what types of data to collect, from street-level imagery to capturing risks like open drains, water points, and electrical hazards.
...
<iframe width="640" height="480" src="https://www.mapillary.com/embed?map_style=Mapillary%20light&image_key=721103253526472&x=0.5&y=0.5&style=photo" frameborder="0"></iframe>
