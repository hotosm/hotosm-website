---
title: 'Datos que mueven ciudades: cartografía participativa para planificar el transporte
  en América Latina y el Caribe'
date: 2025-06-05 16:29:00 Z
Summary Text: Desde Zitácuaro hasta Salina Cruz, comunidades, universidades y gobiernos
  locales de México están generando mapas abiertos del transporte público. Esta estrategia
...
En México, millones de personas utilizan cada día ele transporte público, que en su mayoría opera bajo sistemas no estructurados. Sin embargo, estas rutas son invisibles para quienes planifican, regulan o diseñan políticas públicas, en la mayoría de las ciudades (las ciudades medianas, que experimentan el mayor ritmo de crecimiento). La falta de datos confiables sobre itinerarios, paradas y frecuencias limita la capacidad de tomar decisiones basadas en evidencia, perpetúa desigualdades en el acceso a la movilidad, limita la posibilidad de hacer una planeación integral del crecimiento urbano.

La Iniciativa de las Naciones Unidas sobre la Gestión Global de la Información Geoespacial (UN-GGIM) ha enfatizado que la mayoría de las decisiones relacionadas con el desarrollo sostenible, como la planificación urbana y el diseño del transporte público, requieren información geoespacial. Es decir, cuando el transporte no está en el mapa, no está en la política pública.
...
*Vídeo cortesía de Donobelo y Trufi. Explora la experiencia de mapeo de transporte público en Oaxaca.*

Se impulsó una serie de casos en el país desde 2022: Zitácuaro, Zamora, y actualmente en Toluca, Oaxaca, Salina Cruz, Puerto Escondido con el financiamiento de la [Deutsche Gesellschaft für Internationale Zusammenarbeitm (GIZ)](https://www.giz.de/en/html/index.html) como parte del programa TranSIT, lo cual se prolonga con un diálogo permanente de HOT con autoridades locales de más parte del país dando orientaciones metodológicas y técnicas, sobre cómo obtener y generar datos críticos, de forma colaborativa, para su política urbana. La estrategia combina diagnóstico técnico, formación comunitaria, recopilación de datos y sostenibilidad institucional en materia de gestión de datos. Las ciudades involucradas comparten retos distintos, pero convergen en la necesidad urgente de digitalizar sus ciudades y transporte.
...
* **Apps ciudadanas activas** como Rutómetro

* Gobiernos estatales y municipales usando los datos

* Modelo curricular en universidades para voluntariado técnico
