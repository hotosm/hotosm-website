---
title: 'Fortalecimiento de Comunidades en la Conservación de Manglares: Tecnología
  de Drones y Colaboración Local'
date: 2025-03-03 21:05:00 Z
...
Los manglares son ecosistemas clave para la protección costera, la biodiversidad y la captura de carbono. Sin embargo, enfrentan amenazas como el aumento del nivel del mar, la contaminación y la expansión urbana no regulada. En México, la pérdida de manglares afecta la seguridad alimentaria, la resiliencia ante tormentas y la estabilidad económica de las comunidades pesqueras y turísticas. La falta de datos actualizados sobre su estado y evolución dificulta su protección y restauración, dejando a las comunidades con pocas herramientas para hacer frente a estos desafíos.

Para cerrar esta brecha de información y fortalecer la gobernanza ambiental, esta iniciativa promueve el uso de tecnologías abiertas y metodologías participativas para generar imágenes aéreas y datos de manera autónoma, permitiendo un monitoreo y manejo sostenible de los manglares.

La preservación de este ecosistema no sería posible sin la participación de organizaciones locales que trabajan activamente en la conservación y defensa territorial. **[Guardianas del Conchalito](https://www.instagram.com/guardianasdelconchalito/)** y **[BCSicletos](https://bcsicletos.org/)** son aliados clave en este proceso. *Guardianas del Conchalito* ha liderado esfuerzos de protección de manglares desde 2016 con un enfoque comunitario y de género, promoviendo el liderazgo femenino y la autonomía económica a través de la conservación marina. *BCSicletos*, por su parte, ha trabajado en la defensa del territorio y la sostenibilidad urbana en La Paz desde 2010, vinculando el activismo ambiental con la movilidad y el uso del espacio público.

Daniela Bareño, integrante de *Guardianas del Conchalito*, comparte: *“El manglar es un ecosistema vital que actúa como el pulmón de la ciudad, una barrera natural contra los huracanes y un sumidero de carbono eficiente, capaz de absorber hasta cinco veces más CO₂ que otros bosques. Para fortalecer su restauración, el uso de drones y la capacitación técnica nos permitirán monitorear su estado, identificar áreas afectadas y mejorar nuestras estrategias de conservación, además de formar a jóvenes en el mapeo y la protección de los manglares.”*

La colaboración entre estos grupos permite desarrollar acciones sostenibles con un impacto comunitario real en La Paz. Gracias a su conocimiento del territorio, sus redes locales y su trabajo previo, estas organizaciones garantizan que las estrategias de monitoreo y conservación de los manglares sean apropiadas para el contexto local y tengan continuidad e impacto más allá de la implementación inicial del proyecto.
...
Desde una perspectiva similar, *HOT* ha desarrollado la plataforma *Drone Tasking Manager* basada en *OpenDroneMap*, permitiendo que drones ligeros ejecuten planes de vuelo y realicen procesamiento fotogramétrico dentro de la misma plataforma sin necesidad de instalar software especializado.
...
### **Taller de Introducción a Wikipedia y Wikimedia Commons**

Exploración de estas plataformas como herramientas de incidencia en temas ambientales en la región.

* Se crearon 14 artículos y se editaron 36 sobre organizaciones participantes, territorio, derecho a la ciudad, flora y fauna de La Paz, entre otros.
...
* Introducción a la historia y tipos de drones.

* Principios de fotogrametría y planificación de vuelos.

* Uso de *Drone Tasking Manager* en combinación con *OpenAerialMap*.

* Práctica de vuelo con *DJI Mini 4 Pro*.

### **Ejercicio práctico en el Estero de El Conchalito:**

* Diseño y ejecución de planes de vuelo con drones automatizados y manuales.

* Captura y procesamiento de imágenes aéreas.

* Generación de ortofotos, nubes de puntos y visualización en 3D.
...
*Marco: Ortofoto generada a partir de tres vuelos realizados por BCSicletos y Mangles del Manglito durante la práctica del sábado en El Conchalito. Puede tardar en cargar, también puedes consultarla [aquí](https://crankyserver.com/public/task/8a7ea9f6-0631-4b8e-8f2a-c8e6a7958dbe/3d/).*
...
Además, quienes han sido capacitados en esta iniciativa pueden ahora integrarse en una red de respuesta rápida ante emergencias, facilitando la obtención inmediata de imágenes aéreas post-desastre. Estas imágenes son esenciales para actores clave en la respuesta a emergencias y organizaciones técnicas como *HOT*, ya que permiten la creación de mapas detallados de daños y brindan apoyo crucial a las comunidades en momentos críticos.
...
Esta herramienta permite que drones de gama básica realicen funciones avanzadas de fotogrametría, posibilitando observaciones y monitoreo territorial que antes estaban restringidos a grupos especializados con altos recursos financieros.

Gracias a esta tecnología, ahora es posible generar datos accesibles y de alta calidad, fortaleciendo capacidades locales y abriendo nuevas oportunidades para comunidades que antes no tenían acceso a estas herramientas. Esto representa un paso clave en la construcción de procesos de monitoreo y gestión territorial más inclusivos, donde más personas puedan participar activamente en la recolección y uso de información geoespacial.
