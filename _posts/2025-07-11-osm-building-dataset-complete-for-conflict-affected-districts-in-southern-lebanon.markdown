...
<div style="text-align: center; width: 75%; margin: 0 auto;">
    <img src="/uploads/lebanon-buildigns-2025.png" alt="Added buildings in Lebanon" style="display: block; margin: 0 auto;">
    <div style="font-size: 0.8em; color: #778899; line-height: 1.2; margin-top: 10px;">
        <span>The following map shows the areas where HOTOSM mapped for the Lebanon 2024 campaign. It covered 4 districts and mapped almost 200k buildings thanks to 356 contributors.</span>
    </div>
</div>
...
In areas of dedicated crowdsourced OpenStreetMap efforts, **OSM has been shown to outperform automated machine learning datasets in terms of coverage and precision,** such as [in Gaza last year](https://www.hotosm.org/updates/gaza-osm-buildings-update-2024/)**.**  The same holds true in Lebanon, where **OSM has 65% more buildings in the 4 districts than the other leading open buildings footprints dataset from Microsoft (165,703 vs 253,664).**   Overture, an emerging aggregator of open datasets, can lag behind OSM updates, as shown by the lower numbers of Overture than OSM as of May 2025 below. 
