...
Summary Text: "While we have pretty good field mapping applications, we don’t have
  ...
  share session on September 9th](https://www.eventbrite.com/e/field-mapping-is-the-future-a-tasking-manager-workflow-for-odk-tickets-400186387257),
  2022, during which people can gain an understanding and some experience with the
  idea; we’ll be using the feedback from this session to gauge interest and participation
