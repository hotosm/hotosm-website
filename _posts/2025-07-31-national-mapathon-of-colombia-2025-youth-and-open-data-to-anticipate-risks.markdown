---
title: 'National Mapathon of Colombia 2025: Youth and Open Data to Anticipate Risks'
date: 2025-07-31 23:23:00 Z
Summary Text: The 2025 National Mapathon of Colombia, the second edition of this initiative,
  demonstrated how collaboration between institutions, communities, and youth can
  transform risk management.
Feature Image: "/uploads/mapas%20comunitarios2.jpg"
...
[Versión en español](https://www.hotosm.org/updates/mapaton-nacional-de-colombia-2025-juventudes-y-datos-abiertos-para-anticipar-riesgos/)

## Learn About the National Anticipatory Mapathons

Latin America and the Caribbean is one of the most disaster-prone regions in the world, and Colombia is no exception. Its diverse geography exposes it to multiple threats, from floods to landslides, yet many rural and peripheral areas lack up-to-date geospatial data. The [National Anticipatory Mapathons (MANA)](https://www.hotosm.org/updates/mapatones-anuales-anticipatorios-innovacion-y-colaboracion-para-cerrar-vacios-cartograficos-en-latinoamerica-y-el-caribe/) emerge as a low-cost, highly collaborative solution to anticipate risks by generating open maps created by and for communities.

The MANA methodology combines the participatory definition of priority areas with national authorities, the mobilization of mapping communities, technical training in open mapping, quality validation, and the delivery of ready-to-use data for public policy and territorial planning.

In Colombia, the National Mapathon is implemented thanks to the coordination between the [National Unit for Disaster Risk Management (UNGRD)](https://portal.gestiondelriesgo.gov.co/), the HOT Open Mapping Hub for Latin America and the Caribbean, and the [Agustín Codazzi Geographic Institute (IGAC)](https://www.igac.gov.co/), with the leadership of youth collectives such as YouthMappers, SAGEMA, and TadeoMappers, and networks such as the [National Youth Environmental Network](https://archivo.minambiente.gov.co/index.php/noticias-minambiente/2903-asi-funciona-la-red-nacional-de-jovenes-de-ambiente) and the [Youth Network for Disaster Risk Reduction](https://redjovenesrrdcolombia.org/).
...
![Mapas Comunitarios.jpg](/uploads/Mapas%20Comunitarios.jpg)

The 2025 National Mapathon of Colombia took place from May 5 to June 27 across 12 virtual sessions. Joining the organizing institutions was the sponsorship of TomTom, which awarded 10 gift cards to the highest-contributing mappers.

From the outset, the words of Ana Milena Prada Uribe, Deputy Director for Risk Knowledge at UNGRD, set the tone for the initiative: *“This support was essential to bring information to places that historically lacked data, creating a base map that will allow municipalities to reduce risks and update their planning instruments.”*

Youth leadership once again proved key. Young mapper and organizer Sebastián Bravo shared: *“We organized parallel meetings to learn and exchange feedback, discovering that mapping has many applications. I’m excited to see young people committed to open data so that communities can make decisions based on information they generate themselves.”*

For Iván Darío Camacho Puerto, from IGAC’s Research and Foresight Directorate, this exercise goes beyond traditional geography: *“This allows communities to take ownership and generate knowledge, even in what we call ‘cybergeography,’ a space where new territorialities are created.”*
...
This year’s achievements far surpassed those of the previous edition:

* 255 participants

* 63,000 buildings mapped

* 439 km of roads, mainly rural

* 55 km of waterways

* 13 projects completed in the Tasking Manager, prioritized by UNGRD

<div style="width:100%;height:0;padding-bottom:56%;position:relative;"><iframe src="https://giphy.com/embed/XIVUh4o0qbGkT1lC9g" width="100%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed" allowFullScreen></iframe></div><p><a href="https://giphy.com/gifs/XIVUh4o0qbGkT1lC9g">via GIPHY</a></p>

Vulnerable and hard-to-reach areas were covered, such as La Guajira and complex municipalities in Antioquia and Casanare. The latter, characterized by high population density and a large concentration of buildings, present additional mapping challenges. The work carried out strengthens the base cartography needed for municipal risk management plans and emergency response strategies.
...
Youth and university participation in the organizational effort itself is a key driver for scaling and sustaining the MANA, in addition to fostering professionalization.\
Data gaps are opportunities to integrate citizen science into public policy.\
It is necessary to strengthen validation and continuous monitoring to ensure the effective use of data.
