...
Cada necesidad cartográfica tiene un enfoque adecuado desde el cual evaluar desafíos y oportunidades. Identificar estos retos permite definir metodologías más efectivas y realizar experimentos a pequeña escala. Incluso un ejercicio mínimo puede generar reflexiones valiosas dentro del equipo de decisión, mientras que uno más amplio enriquece la información con la diversidad de perspectivas que aporta la comunidad.