...
Summary Text: "Hey All,As part of the CAP103 project, financed by USAID, being
  run in the North of Haiti right now we have started coordinating motorcycles for
  survey purposes.[inline:IMG_2619.JPG]The purpose of using the motos
  is two-fold:1. To be able to transport teams of OSM surveyors to remote locations
  it would otherwise be difficult to reach.2. To be able to collect a solid network
