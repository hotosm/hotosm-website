---
title: 'Cultivando el conocimiento abierto: taller de mapeo colaborativo para docentes
  del Tec de Monterrey'
date: 2025-03-24 12:35:00 Z
Summary Text: Docentes del Tec de Monterrey se capacitaron en herramientas de mapeo
  abierto para integrar la ciencia ciudadana en la educación universitaria. A través
  de sesiones teóricas y prácticas, desarrollaron proyectos de impacto social en Querétaro
...
“El potencial del mapeo abierto en la educación universitaria se hizo evidente cuando discutimos sobre el mapeo humanitario como una herramienta clave en la ayuda humanitaria y su potencial para fortalecer la resiliencia comunitaria”, comenta el Dr. Kacper Przyborowski, profesor de la Licenciatura en Relaciones Internacionales. “Este taller con mis estudiantes me inspiró a coordinar junto a HOT una sesión que capacitara a colegas y a mí sobre la incorporación del mapeo abierto como una metodología innovadora para abordar problemáticas sociales desde la enseñanza, la investigación y la acción en campo”.

<a data-flickr-embed="true" href="https://www.flickr.com/photos/hotosm/albums/72177720323708372" title="CADi de Mapeo Abierto a Docentes del Tec de Monterrey, Campus Querétaro"><img src="https://live.staticflickr.com/65535/54316771358_0bdb9ffb7d_b.jpg" width="1024" height="768" alt="CADi de Mapeo Abierto a Docentes del Tec de Monterrey, Campus Querétaro"/></a><script async src="//embedr.flickr.com/assets/client-code.js" charset="utf-8"></script>

## Del aula al territorio: explorando el mapeo abierto en la educación

El curso se estructuró en tres jornadas intensivas con sesiones teóricas y prácticas, abordando desde los fundamentos del mapeo hasta aplicaciones avanzadas para proyectos de investigación y desarrollo comunitario.

### Día 1: Fundamentos del mapeo abierto y herramientas iniciales
...
La última jornada discutió brevemente la intersección entre OpenStreetMap y Wikimedia, resaltando su potencial en proyectos educativos a través de datos geolocalizados.

Durante la jornada, se enfatizaron estrategias para integrar el mapeo en la currícula universitaria. El enfoque del mapeo abierto se planteó desde la mejora continua, reconociendo que ningún mapa es definitivo, sino una representación dinámica en evolución. Se reflexionó sobre cómo estas herramientas pueden fortalecer la comprensión del territorio, fomentando la participación comunitaria y la justicia social a través de la ciencia ciudadana. Además, se exploraron estrategias para la sostenibilidad del conocimiento mapeador, como la formación de formadores y la mentoría entre docentes y estudiantes para crear una red de aprendizaje colaborativo. También se resaltó la importancia de empoderar a las juventudes no sólo como participantes, sino como líderes de iniciativas de mapeo, promoviendo la integración del mapeo abierto en procesos educativos y de incidencia ciudadana.
...
El taller resultó en la conceptualización de cuatro proyectos con gran potencial de impacto:

### DistritoQro: Un laboratorio urbano de ciencia ciudadana

DistritoQro es un proyecto piloto exploratorio que busca reconocer y definir los límites de una zona de intervención en Querétaro, generando datos que permitan entender mejor el territorio. Este proyecto parte de la necesidad de construir un diagnóstico integral que sirva como base para que actores públicos, privados y académicos puedan tomar decisiones informadas sobre el desarrollo urbano y la planificación territorial.

La metodología propuesta emplea técnicas de mapeo abierto como recorridos urbanos, entrevistas, encuestas y análisis físico-demográfico. Herramientas como OpenStreetMap, uMap, Mapillary y Tasking Manager serán utilizadas para recopilar y organizar la información. Se implementarán estrategias de ciencia ciudadana y se identificará a actores clave que puedan aportar desde diversas disciplinas.
...
Dentro de la metodología, se propone recopilar datos de unidades económicas relacionadas con la compra, venta y donación de bienes de segunda mano mediante herramientas como Mapillary y Organic Maps. Se realizarán encuestas con KoboToolbox y se integrarán los datos en uMap para generar un atlas colaborativo. Además, se capacitará a estudiantes y comunidad en el uso de herramientas de mapeo.
...
El proyecto propone diseñar recorridos estratégicos donde se capturarán datos mediante Mapillary y HOT ChatMap. Se capacitará a estudiantes en técnicas de documentación geoespacial y análisis de patrones de manifestaciones culturales. La información será sistematizada en una plataforma digital accesible.
...
El acceso desigual a infraestructura digital en comunidades vulnerables limita las oportunidades educativas. Este proyecto busca identificar las brechas en conectividad y acceso a tecnología para apoyar la toma de decisiones en políticas de inclusión digital.

Dentro de la metodología, se propone mapear escuelas, bibliotecas y centros comunitarios utilizando OpenStreetMap, Overpass Turbo y Mapillary. Se aplicarán encuestas a educadores y estudiantes para identificar necesidades y desafíos. La información recopilada será analizada y visualizada en un informe abierto.
...
El compromiso generado en este curso sienta las bases para futuras iniciativas de formación, con el potencial de escalar estos proyectos a nivel local, nacional e incluso internacional. La semilla del mapeo abierto ha sido sembrada, y ahora, el reto es seguir cultivándola.