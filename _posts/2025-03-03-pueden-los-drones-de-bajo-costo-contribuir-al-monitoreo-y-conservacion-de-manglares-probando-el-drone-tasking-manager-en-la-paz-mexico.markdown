---
title: "¿Pueden los drones de bajo costo contribuir al monitoreo y conservación de
  manglares? Probando el Drone Tasking Manager en La Paz, México"
date: 2025-03-03 00:29:00 Z
Summary Text: Drone Tasking Manager (DroneTM) es un bien digital público que permite
...
* **Procesamiento automático de imágenes** impulsado por **[OpenDroneMap](https://opendronemap.org)**, para generar modelos 3D, imágenes aéreas y modelos de elevación detallados.
...
* **[Un bien digital público](https://www.hotosm.org/updates/building-dronetm/):** Asegura que las comunidades tengan acceso a datos geoespaciales abiertos y de alta calidad sin depender de soluciones propietarias costosas.

Junto con nuestro socio [NAXA](https://naxa.com.np/), el Equipo Humanitario de OpenStreetMap (HOT) ha realizado pruebas de campo y despliegues iterativos en regiones diversas como Indonesia, Nepal, Dominica y Santa Lucía, como lo [documenta Niraj Adhikari, desarrollador de software geoespacial de NAXA](https://www.hotosm.org/updates/building-dronetm/). Ahora, por primera vez, hemos probado su potencial para apoyar otro frente del desarrollo comunitario: el monitoreo y la conservación de manglares.
...
<iframe
src="https://crankyserver.com/public/task/8a7ea9f6-0631-4b8e-8f2a-c8e6a7958dbe/map/?t=orthophoto"
width="100%"
height="700"
style="border: none;"
allowfullscreen
...
Puedes descargar las ortofotos generadas por los vuelos de dron directamente desde [OpenAerialMap](https://map.openaerialmap.org/#/-110.42078644037247,24.126750916699837,18/latest/67e32103bfdbb865ae6b147b?_k=kvkvro).
...
* Prueba [DroneTM](https://dronetm.org/) en tus proyectos de mapeo.

* Contribuye a su desarrollo a través de nuestro [repositorio en GitHub](https://github.com/hotosm/Drone-TM).

* Conoce más sobre nuestras pruebas de campo y despliegues [aquí](https://www.hotosm.org/tech-suite/drone-tasking-manager/) y [aquí](https://www.hotosm.org/updates/building-dronetm/).

* Para una mirada profunda sobre la capacitación y práctica en La Paz, México, visita [esta publicación](https://www.hotosm.org/updates/fortalecimiento-de-comunidades-en-la-conservacion-de-manglares-tecnologia-de-drones-y-colaboracion-local/).

## Más lecturas

* [Construyendo DroneTM: Una solución como bien digital para democratizar el mapeo con drones](https://www.hotosm.org/updates/building-dronetm/) \[lectura en inglés\]

* [Drones para cuidado y vigilancia del territorio: conocimiento abierto al servicio de la comunidad](https://diff.wikimedia.org/es/2025/03/21/drones-para-la-vigilancia-y-cuidado-del-territorio-conocimiento-libre-al-servicio-de-la-comunidad/)

* [Fortaleciendo comunidades en la conservación de manglares: tecnología de drones y colaboración local](https://www.hotosm.org/updates/fortalecimiento-de-comunidades-en-la-conservacion-de-manglares-tecnologia-de-drones-y-colaboracion-local/)