...
The first activation phase involved establishing contact with relevant authorities, such as Civil Protection and [the National Center for Disaster Prevention](https://www.gob.mx/cenapred) (CENAPRED). However, disorganization and the disruption of telecommunications and energy caused by the disaster initially hindered this connection, especially with local institutions. It was necessary to rely on university contacts from [the Autonomous University of the State of Mexico](https://www.uaemex.mx/) (UAEMEX) and international organizations such as [the United Nations Children's Fund](https://www.unicef.org/mexico/conoce-unicef) (UNICEF) to obtain crucial information about the extent of the damage and priority needs, as well as to weave coordination with authorities from one contact to another.
