...
## Proyecto San Antonio de Prado

El proyecto de mapeo en este corregimiento tuvo como objetivo actualizar cuatro de las ocho veredas que lo conforman, con el propósito de contribuir a la gestión del riesgo por deslizamientos. La iniciativa se desarrolló durante seis meses y se llevó a cabo en cuatro fases:

1. Entrenamiento a la comunidad

2. Mapeo con dron

3. Mapeo en campo y de forma remota
...
En la tercera fase, los recorridos se extendieron a distintas zonas dentro de las cuatro veredas a mapear (ver enlace): La Verde, Montañita, El Salado y Potreritos. Estos recorridos se realizaron en moto, utilizando una GoPro montada con soporte, lo que permitió capturar imágenes de alta calidad de estas zonas rurales e importarlas a la plataforma abierta de Mapillary. Las fotografías fueron posteriormente vinculadas a las plataformas OSM y JOSM, donde se añadieron atributos como características de vías, edificios, viviendas e infraestructura (ver imagen 2).
...
En este sentido, se realizaron varios recorridos por el barrio para la toma de imágenes utilizando una cámara GoPro. Estas imágenes fueron posteriormente subidas a la plataforma Mapillary (ver enlace). A partir de esta información, se construirá el modelo de datos de mapeo, es decir, la metodología para identificar las aplicaciones que se utilizarán en la actualización geográfica, adaptadas a las condiciones específicas del barrio.
...
Gracias a su versatilidad, eficiencia de carga y estabilidad, la GoPro permitió capturar imágenes de alta calidad incluso en condiciones de movimiento. Esto fue especialmente útil para alimentar la cartografía de áreas extensas mediante recorridos en motocicleta, como en el proyecto de San Antonio de Prado. Su desempeño evidencia el potencial de esta herramienta para integrarse de manera masiva en proyectos de mapeo, como una opción significativa y de bajo costo para la planificación y gestión territorial.