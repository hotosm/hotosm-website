---
title: 'Mapatones Anuales Anticipatorios: Innovación y Colaboración para Cerrar Vacíos
  Cartográficos en Latinoamérica y el Caribe'
...
OpenStreetMap (OSM), una plataforma colaborativa global, actúa como el eje central de esta iniciativa. Con una comunidad activa de 10 millones de personas usuarias registradas, distribuida en más de 50 países, OSM ha demostrado su impacto al proporcionar mapas editables y accesibles que apoyan la toma de decisiones informada durante crisis y desastres, y para la preparación a los mismos. Los MANA aprovechan esta infraestructura tecnológica para generar datos actualizados y de alta precisión sobre el territorio y sus riesgos, enfocados a áreas de vulnerabilidad delimitadas y priorizadas por las autoridades y especialistas de cada país, inmoviliza mapeadores en su mayoría locales, además de la comunidad regional. Como bien se dice: "No hay mejor mapeador que el que conoce y encarna su propio territorio."

La estrategia de estos mapatones busca cerrar rápidamente los vacíos cartográficos en áreas clave, como la gestión de desastres, al mismo tiempo que visibilizar las iniciativas adoptadas por grupos de instituciones nacionales en cada país, así como por organizaciones regionales, con el objetivo de consolidar una comunidad de conocimiento y fortalecer el aprendizaje práctico de la ciencia ciudadana. El Hub de América Latina y el Caribe de HOT actúa como aliado técnico, encargándose de la estrategia de movilización comunitaria, de la creación de proyectos en el Gestor de Tareas ([Tasking Manager](https://tasks.hotosm.org/)), la impartición de sesiones de capacitación básica y de mapeo supervisado, y la organización de la validación de los datos contribuidos.

En 2024, los MANA han demostrado su potencial transformador con implementaciones exitosas en Ecuador, Perú, Colombia y Guatemala, y toma de decisiones con uso de la información mapeada.
...
Gracias al trabajo conjunto de la [Secretaría de Gestión de Riesgos de Ecuador](https://www.gestionderiesgos.gob.ec/), el LAC Hub de HOT y con involucramiento fundamental del grupo Youth Mappers Geomap ESPE, se desarrolló una metodología adaptada a diferentes contextos de mapeo anticipatorio. Este enfoque combinó criterios clave para delimitar áreas prioritarias, agregando un nivel más de análisis a las identificaciones de la secretaría, incluyendo:

* Identificación de áreas frecuentemente afectadas por fenómenos naturales.

* Definición de zonas específicas de alto interés por parte de las autoridades.

* Uso de la metodología de evaluación multicriterio de Geomap-ESPE, considerando factores como pendientes, precipitaciones, cercanía a ríos y cobertura vegetal.

* Priorización de áreas extensas que requerían estrategias específicas para su mapeo en tiempos limitados (pre-mapeo en Mapswipe).
...
En 2024, Perú llevó a cabo su Cuarto Mapatón Nacional Anual co liberado desde hace varios años por la [Comisión Nacional de Investigación y Desarrollo Aeroespacial (CONIDA)](https://www.gob.pe/institucion/conida/institucional) y en colaboración con [AmeriGEO](https://www.amerigeo.org/), red con la que se ha podido construir un acercamiento duradero a través de los mapatones, y reuniendo, además, a varios ministerios como el de Vivienda, Construcción y Saneamiento (MVCS), la Unidad de Gestión de Riesgo y Desastre, el Organismo de Evaluación y Fiscalización Ambiental (OEFA), y  apoyado por HOT a través de la creación de proyectos de mapeo; y, a partir del cuarto año, por el Equipo Humanitario de OpenStreetMap Team (HOT) en una movilización más amplia de comunidades mapeadoras. Este esfuerzo tuvo como objetivo generar datos geoespaciales críticos y capacitar a participantes en diversas temáticas relacionadas con la gestión de riesgos y el uso de tecnologías avanzadas.

Durante mayo, HOT lideró tres talleres formativos virtuales enfocados en mapeo remoto. Estos talleres introdujeron a los participantes en el uso de datos satelitales y herramientas como Copernicus y [OpenAerialMap](https://openaerialmap.org/). Gracias a la participación de 45 mapeadores destacados, se lograron documentar 24,131 edificios y 212 km de carreteras en dos áreas prioritarias de la Amazonía peruana: Jaén (185,000 habitantes) y Ciudad Constitución (5,000 habitantes). Estas áreas habían sido identificadas por CONIDA como regiones con necesidades críticas de actualización cartográfica, además de distintas organizaciones participantes.
...
En junio, como parte de las actividades con involucramiento pluri institucional, la CONIDA lideró dentro del espacio del mapatón una actividad presencial de tres días que reunió a actores locales e internacionales, jóvenes desarrolladores, programadores y especialistas en teledetección, fomentando la innovación mediante el desarrollo de soluciones basadas en datos de Observación de la Tierra. Equipos multidisciplinarios trabajan en proyectos que responden a necesidades reales del país. Al finalizar, se otorgaron premios a las ideas más innovadoras, demostrando el potencial de la colaboración entre tecnología y conocimiento local.
...
Ante esta situación, el mapatón permitió enfocar los esfuerzos de los voluntarios en el mapeo de las principales zonas afectadas, donde se requería una actualización cartográfica urgente. Como resultado, se crearon cuatro proyectos en el Tasking Manager, los cuales fueron completados satisfactoriamente en pocos días.
...
En 2024, Guatemala llevó a cabo su primer gran mapatón de Caminos Rurales, adaptando su enfoque a un contexto diferente pero con el mismo propósito central. Liderado por el PNUD y HOT, este esfuerzo apoyó la planificación del programa prioritario del nuevo gobierno, “Avenidas para el Buen Vivir”, destinado a diagnosticar el estado de los caminos y carreteras del país para impulsar mejoras en la infraestructura y potenciar el desarrollo rural.
...
Antes del proyecto, Guatemala enfrentaba un vacío crítico en datos geoespaciales sobre su red vial. Este vacío limitaba todo proceso de toma de decisiones así como la inversión pública en infraestructura . Comparte Juan Carlos Méndez, director del programa Avenidas para el Buen Vivir, que se tenía *“un vacío tan grande que los caminos no registrados simplemente no existían en términos de planificación pública. Sin datos precisos, no podíamos conectar a la Guatemala urbana con la Guatemala rural, y eso perpetúa la exclusión social y económica.”*
...
* Identificación de **17,018 kilómetros de senderos rurales**, esenciales para la movilidad en áreas remotas, pero que constituyen frenos para la comunicación constante de comunidades con centros económicos.
...
Los Mapatones Nacionales Anuales Anticipatorios (MANA) son mucho más que eventos colaborativos puntuales: son una herramienta sistematizada e integradora para fortalecer la prevención y gestión de riesgos de desastres, construyendo conocimiento territorial preciso y actualizado a través del empoderamiento ciudadano, sobre el largo plazo.

Al integrar la participación conjunta de comunidades, organizaciones y gobiernos, los MANA aseguran que los responsables de la toma de decisiones puedan confiar en datos geoespaciales de alta calidad para planear, priorizar y asignar recursos de manera más eficiente, alcanzando a las comunidades más vulnerables, logrando también una diversidad de miradas en la generación de datos.

Es la sociedad en su conjunto la que, de manera colaborativa, produce un mapa nacional que refleja todas las voces y necesidades del territorio. Desde el LAC Hub de HOT, continuamos trabajando para potenciar el liderazgo de los jóvenes en estas iniciativas, quienes día a día demuestran su capacidad y compromiso para construir un futuro más seguro, sostenible y conectado, aportando esfuerzo distribuido. Contamos con programas como [Open Mapping For All (OM4A)](https://www.hotosm.org/hubs/open-mapping-hub-latin-america-and-the-caribbean/) para acompañar a docentes y estudiantes en la implementación del mapeo en las aulas de la región, además de colaborar permanentemente con redes de jóvenes como Youth Mappers, UNDRR, etc.
...
Mirando hacia el futuro, nos enfocamos en fortalecer el apoyo técnico, consolidar alianzas institucionales de escala nacional y regionales, y fomentar una cultura de mapeo abierto y de ciencias ciudadana para la política pública a largo plazo. Así, aseguramos la continuidad y trascendencia de esta iniciativa, contribuyendo al desarrollo sostenible y al bienestar de los ciudadanos de América Latina y el Caribe.

El futuro directo de los MANA es su apropiación por las instituciones y universidades, asimilando por completo el valor del mapeo abierto como insumo fácilmente accionable y actualizable de toma de decisiones. Un insumo que sin OpenStreetMap implicaría amplios presupuestos y plazos, mientras que cada día sin un mapa mantiene las comunidades en el subdesarrollo y la inseguridad.