...
I wanted to learn more about open source tools and how OpenStreetMap (OSM) worked. When I first heard about OSM in 2013 from an early OSM adopter who had moved to Utah ([Martijn of MapRoulette fame,](https://maproulette.org/) for those who know it), it sounded like a niche project, but OSM has since grown into a major GIS resource! I also used to work with Utah’s open geospatial database, which dated back to the 1980s, and later did GIS work for humanitarian projects. So, I was excited to combine both interests at HOT. 
...
I’m interested to see how OSM’s resilience relates to [the humanitarian “reset”](https://www.unocha.org/news/humanitarian-reset-0). It’s an incredibly tough time in the sector with massive funding cuts, but I see OSM as one of the widely used platforms that will survive. There’s nothing else quite like it. 
...
*Jessie representing HOT at the Humanitarian Networks and Partnerships Week, 2024*
...
[Objective Troy: A Terrorist, a President, and the Rise of the Drone by Scott Shane](https://www.goodreads.com/book/show/25241648-objective-troy), to better understand modern warfare. To be honest, though, you’ll usually find me reading historical fiction for a proper escape. 

*Learn more about Jessie [here](https://www.hotosm.org/people/jessica-pechmann/).*
